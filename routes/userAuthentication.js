...
res.json({ success: true, message: 'not registered!' });
    ...
    // res.json({ success: true, message: 'Account registered!',id:user._id });
...
console.log(len);
// if(len==0){
//  friendsArray[len].id=req.body.id;
//  friendsArray[len].name=req.body.name;
//  friendsArray[len].emailid=req.body.emailid;
// }
const details = {
            id: req.body.id,
            name:req.body.name,
...
//       User.findOneAndUpdate({_id:req.params.id},{$set:{"local.waitingMsg":chatArray}},function(err,user){
//   if(err){
//     console.log("error");
//     }
//     else
...
// if(ln===1 || ln==1){
//   console.log("msg length is 1");
// let newchat1 = new Chat();
//     newchat1.fromUserId = req.body.fromUserId;
//     newchat1.toUserId = req.body.toUserId;
//     newchat1.message = req.body.message;
//     newchat1.date = req.body.date;

//     newchat1.save(function(err) {
//         if (err) {
//            return  res.json(err);
//             // console.log(err);
//  console.log("error");
...
//            console.log("saving");
//            // console.log(msg);
//               return res.json({ success: true, message: 'chat message saved!' }); // Return success message
...
// {'$or':[{'$and':[{'toUserId': fromUserId},{'fromUserId': toUserId}]},{'$and':[{ 'toUserId': toUserId},{'fromUserId':fromUserId}] }]}
...
//  let fromUserId = req.body.id;
//   Chat.find({'$or':[{'toUserId': fromUserId},{'fromUserId':fromUserId}] },function(err,msg){
    
//     { $or: [ { 'toUserId': fromUserId}}, { price: 10 } ] } if (err) {
//       console.log("error");
//           res.json({ success: false, message: err }); 
//         } else {
//           console.log(" historymessages in backend");
//           console.log(msg);
//           if (msg) {
//             res.json({ success: true, message: 'history', data:msg});
//   }
// }
//   });
// });
